...
public class PathUtil {
    ...
    public static File getFileDiskFile(Context context, String fileName) throws IOException {
        return getFileDiskFile(context, fileName, true);
    }

    public static File getFileDiskDir(Context context, String dirName) throws IOException {
        File folder = getDiskCacheDir(context, dirName);
        if (!folder.exists()) {
            folder.mkdirs();
        }
        return folder;
    ...
    public static File getFileDiskFile(Context context, String fileName, boolean isCreate) throws IOException {
        return getFileDiskFile(context, FILEPATH, fileName, isCreate);
    }

    public static File getFileDiskFile(Context context, String dirName, String fileName, boolean isCreate) throws IOException {
